    ...
    public class FindFile
    {
        ...
        internal static class Kernel32
        {
            ...
            public struct FILETIME
            {
                ...
                {
                    return DateTime.FromFileTime(dwLowDateTime | ((long)dwHighDateTime << 32));
                }
            };
        ...
        public struct Info
        {
            ...
            /// <summary> Gets or sets the file or folder CreationTime </summary>
            public DateTime CreationTime { get; set; }
            /// <summary> Gets or sets the file or folder LastAccessTime </summary>
            public DateTime LastAccessTime { get; set; }
            /// <summary> Gets or sets the file or folder LastWriteTime </summary>
        ...
        public sealed class FileFoundEventArgs : EventArgs
        {
            ...
            /// <summary> Gets the file or folder CreationTime </summary>
            public DateTime CreationTime { get { return _ff.Value.ftCreationTime.ToDateTime(); } }
            /// <summary> Gets the file or folder LastAccessTime </summary>
            public DateTime LastAccessTime { get { return _ff.Value.ftLastAccessTime.ToDateTime(); } }
            /// <summary> Gets the file or folder LastWriteTime </summary>
            public DateTime LastWriteTime { get { return _ff.Value.ftLastWriteTime.ToDateTime(); } }
        ...
        public int MaxPath
        {
            ...
            set { Array.Resize(ref _ff.Buffer, InRange(value, Kernel32.MAX_PATH, 0x100000)); }
        }
